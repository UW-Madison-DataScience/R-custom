...
Comparison operators also work with character objects. The greater than (`>`) and less than (`<`) operators don't make as much sense with character objects, but `==` and `!=` work well for comparing character objects. 
