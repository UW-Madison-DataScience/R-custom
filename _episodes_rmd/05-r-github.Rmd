...
![The branch dialog, with the option to add a remote](../fig/05-branch-add-remote.png){: .image-with-shadow }
...
weird, since the 'main' branch already exists in the local repo by default, but do it anyway. In the next dialog that pops up,
choose 'overwrite'.
